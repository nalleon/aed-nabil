package es.iespuertodelacruz.nla.persona.infrastructure.adapters.secondary.mapper;

import es.iespuertodelacruz.nla.persona.domain.Persona;
import es.iespuertodelacruz.nla.persona.infrastructure.adapters.secondary.PersonaEntity;
